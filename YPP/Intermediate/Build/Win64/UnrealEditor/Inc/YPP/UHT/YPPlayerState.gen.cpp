...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AYPPlayerState_Statics::NewProp_GameHighScore = { "GameHighScore", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AYPPlayerState, GameHighScore), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_GameHighScore_MetaData), NewProp_GameHighScore_MetaData) };
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AYPPlayerState_Statics::NewProp_Exp = { "Exp", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AYPPlayerState, Exp), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Exp_MetaData), NewProp_Exp_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AYPPlayerState_Statics::NewProp_CharacterIndex = { "CharacterIndex", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AYPPlayerState, CharacterIndex), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CharacterIndex_MetaData), NewProp_CharacterIndex_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AYPPlayerState_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AYPPlayerState_Statics::NewProp_GameHighScore,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AYPPlayerState_Statics::NewProp_CharacterLevel,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AYPPlayerState_Statics::NewProp_Exp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AYPPlayerState_Statics::NewProp_CharacterIndex,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Git_Study_Unreal_YPP_Source_YPP_Public_YPPlayerState_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AYPPlayerState, AYPPlayerState::StaticClass, TEXT("AYPPlayerState"), &Z_Registration_Info_UClass_AYPPlayerState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AYPPlayerState), 1512644976U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Git_Study_Unreal_YPP_Source_YPP_Public_YPPlayerState_h_2101741171(TEXT("/Script/YPP"),
	Z_CompiledInDeferFile_FID_Git_Study_Unreal_YPP_Source_YPP_Public_YPPlayerState_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Git_Study_Unreal_YPP_Source_YPP_Public_YPPlayerState_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
