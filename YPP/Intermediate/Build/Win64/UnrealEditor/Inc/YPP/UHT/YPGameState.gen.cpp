...
void Z_Construct_UClass_AYPGameState_Statics::NewProp_bGameCleared_SetBit(void* Obj)
{
	((AYPGameState*)Obj)->bGameCleared = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AYPGameState_Statics::NewProp_bGameCleared = { "bGameCleared", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AYPGameState), &Z_Construct_UClass_AYPGameState_Statics::NewProp_bGameCleared_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bGameCleared_MetaData), NewProp_bGameCleared_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AYPGameState_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AYPGameState_Statics::NewProp_bGameCleared,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Git_Study_Unreal_YPP_Source_YPP_Public_YPGameState_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AYPGameState, AYPGameState::StaticClass, TEXT("AYPGameState"), &Z_Registration_Info_UClass_AYPGameState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AYPGameState), 3579051351U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Git_Study_Unreal_YPP_Source_YPP_Public_YPGameState_h_566874401(TEXT("/Script/YPP"),
	Z_CompiledInDeferFile_FID_Git_Study_Unreal_YPP_Source_YPP_Public_YPGameState_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Git_Study_Unreal_YPP_Source_YPP_Public_YPGameState_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
