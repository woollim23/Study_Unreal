...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_AYPPlayerController_Statics::NewProp_MenuWidgetClass = { "MenuWidgetClass", nullptr, (EPropertyFlags)0x0024080000010005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AYPPlayerController, MenuWidgetClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UYPGameplayWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MenuWidgetClass_MetaData), NewProp_MenuWidgetClass_MetaData) };
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_AYPPlayerController_Statics::NewProp_ResultWidgetClass = { "ResultWidgetClass", nullptr, (EPropertyFlags)0x0024080000010005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AYPPlayerController, ResultWidgetClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UYPGameplayResultWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ResultWidgetClass_MetaData), NewProp_ResultWidgetClass_MetaData) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AYPPlayerController_Statics::NewProp_MenuWidget = { "MenuWidget", nullptr, (EPropertyFlags)0x0040000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AYPPlayerController, MenuWidget), Z_Construct_UClass_UYPGameplayWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MenuWidget_MetaData), NewProp_MenuWidget_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AYPPlayerController_Statics::NewProp_ResultWidget = { "ResultWidget", nullptr, (EPropertyFlags)0x0040000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AYPPlayerController, ResultWidget), Z_Construct_UClass_UYPGameplayResultWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ResultWidget_MetaData), NewProp_ResultWidget_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AYPPlayerController_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AYPPlayerController_Statics::NewProp_MenuWidgetClass,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AYPPlayerController_Statics::NewProp_ResultWidgetClass,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AYPPlayerController_Statics::NewProp_MenuWidget,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AYPPlayerController_Statics::NewProp_ResultWidget,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Git_Study_Unreal_YPP_Source_YPP_Public_YPPlayerController_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AYPPlayerController, AYPPlayerController::StaticClass, TEXT("AYPPlayerController"), &Z_Registration_Info_UClass_AYPPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AYPPlayerController), 3340285209U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Git_Study_Unreal_YPP_Source_YPP_Public_YPPlayerController_h_874709032(TEXT("/Script/YPP"),
	Z_CompiledInDeferFile_FID_Git_Study_Unreal_YPP_Source_YPP_Public_YPPlayerController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Git_Study_Unreal_YPP_Source_YPP_Public_YPPlayerController_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
